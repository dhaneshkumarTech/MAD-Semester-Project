      ...
      child: Scaffold(
                  ...
                  tabs: [
                    Tab(
                      child: Row(
                        ...
                        children: [
                          Image.asset(
                              'assets/DashboardImages/Icons/desert.png'),
                    ...
                    Tab(
                      child: Row(
                        ...
                        children: [
                          Image.asset(
                              'assets/DashboardImages/Icons/beaches.png'),
                          const Text('Beaches',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Colors.black,
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: ListView(
                                      ...
                                      children: [
                                        Image.asset(
                                          'assets/CategoriesImages/skardu.png',
                                          width: 412,
                                          fit: BoxFit.fill,
                                        ),
                                        Image.asset(
                                          'assets/CategoriesImages/Khaplu.png',
                                          width: 412,
                                          fit: BoxFit.fill,
                                        ),
                                        Image.asset(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ElevatedButton.icon(
                                          ...
                                          icon: Image.asset(
                                              'assets/DashboardImages/Icons/sites.png'),
                                        ),
                                        ElevatedButton(
                                          onPressed: () {},
                                          style: ElevatedButton.styleFrom(
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            ...
            BottomNavigationBarItem(
              icon: ImageIcon(
                const AssetImage("assets/BottomAppBarIcons/plane.png"),
                color: themeColor,
              ),
              label: 'Plan',
            ),
